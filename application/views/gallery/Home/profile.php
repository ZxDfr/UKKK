                    ...
                    <div class="col-3 d-none d-md-block border-end">
                        <div class="card-body">
                            <div class="mb-3 mt-4 text-center">
                                <span class="avatar avatar-xl rounded" style="box-shadow: none;background-image: url(<?= base_url('dist/img/gambar/azuki.jpg') ?>)"></span>
                            </div>
                            <div class="card-title mb-1 text-center"><?= $this->session->userdata('Username') ?></div>
                            <div class="text-muted text-center  mb-4">Software Enginering</div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                Birth date: <strong>02/01/2006</strong>
                            </div>
                            <div>
