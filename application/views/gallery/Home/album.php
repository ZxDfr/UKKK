    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h5 class="page-title text-danger">
                        ALBUM
                    </h5>
                    <div class="text-muted mt-1 text-danger">1-1 of 1 Album</div>
                </div>
                <!-- Page title actions -->
            ...
            <div class="row row-cards">
                ...
                ?>
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <!-- Photo -->
                            <div class="img-responsive img-responsive-21x9 card-img-top" style="background-image: url(<?= base_url('dist/img/gambar/zelda_800.gif') ?>)"></div>
                            <div class="card-body">
