...
<div class="page-wrapper">
    <div class="page-header d-print-none">
        <div class="container-xl">
            <h2 class="page-title text-center text-danger" style="display: block; text-align: center;">USER</h2>
        </div>
    </div>
    <div class="page-body">
        <div class="container-xl">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card">
                        <div class="card-body p-4 text-center">
                            <span class="avatar avatar-sm" style="box-shadow: none;background-image: url(<?= base_url('dist/img/avatar/azuki.jpg') ?>)"></span>
