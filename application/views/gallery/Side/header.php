...
<head>
  ...
  <title><?= $title ?></title>
  <link rel="shortcut icon" href="<?= base_url('/dist/img/logo/pixel2.png') ?>" type="image/png" size="32x32">
  <!-- CSS files -->
...
<body class="d-flex flex-column" style="background-image:url(<?= base_url('dist/img/gambar/rom.gif') ?>); background-repeat:no-repeat; background-size:cover;">
